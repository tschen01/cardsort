/* interact.js v1.2.9 | https://raw.github.com/taye/interact.js/master/LICENSE */ var $jscomp = $jscomp || {};
$jscomp.scope = {};
$jscomp.ASSUME_ES5 = !1;
...
$jscomp.polyfill = function (m, J, r, M) {
    if (J) {
        ...
        M = r[m];
        J = J(M);
        J != M && null != J && $jscomp.defineProperty(r, m, { configurable: !0, writable: !0, value: J });
    }
};
$jscomp.polyfill(
    "Math.hypot",
    function (m) {
        return m
            ...
            : function (m, r, M) {
                  ...
                  r = Number(r);
                  var B,
                      u = Math.max(Math.abs(m), Math.abs(r));
                  for (B = 2; B < arguments.length; B++) u = Math.max(u, Math.abs(arguments[B]));
                  if (1e100 < u || 1e-100 > u) {
                      m /= u;
                      r /= u;
                      var x = m * m + r * r;
                  ...
                  x = m * m + r * r;
                  for (B = 2; B < arguments.length; B++) (F = Number(arguments[B])), (x += F * F);
                  return Math.sqrt(x);
              };
    },
    "es6-impl",
...
(function (m) {
    ...
    function Qa(a, b, c) {
        ...
        b = Math.max(a.timeStamp / 1e3, 0.001);
    ...
    function Aa(a, b) {
        b = b || {};
        Sa && Ra(a) ? (sa("screen", a, b), (b.x += v.scrollX), (b.y += v.scrollY)) : sa("page", a, b);
        return b;
    }
    function Ta(a, b) {
        b = b || {};
    ...
    function Ca(a) {
        return (a = a instanceof Ua ? a.getBoundingClientRect() : a.getClientRects()[0]) && { left: a.left, right: a.right, top: a.top, bottom: a.bottom, width: a.width || a.right - a.left, height: a.height || a.bottom - a.top };
    }
    function ta(a) {
        var b = Ca(a);
        if (!lb && b) {
    ...
    function Va(a) {
        for (var b = { pageX: 0, pageY: 0, clientX: 0, clientY: 0, screenX: 0, screenY: 0 }, c, d = 0; d < a.length; d++) for (c in b) b[c] += a[d][c];
    ...
    function Ea(a) {
        if (a.length || (a.touches && 1 < a.touches.length)) {
            ...
            return { x: b, y: c, left: b, top: c, width: Math.max(a[0].pageX, a[1].pageX) - b, height: Math.max(a[0].pageY, a[1].pageY) - c };
        }
    }
    function Fa(a, b) {
        b = b || H.deltaSource;
    ...
    function Ga(a, b, c) {
        ...
        F(b) && ((b = (d - b) % 360), 315 < b ? (d -= (360 + d / 360) | 0) : 135 < b ? (d -= (180 + d / 360) | 0) : -315 > b ? (d += (360 + d / 360) | 0) : -135 > b && (d += (180 + d / 360) | 0));
        return d;
    }
    function na(a, b) {
        var c = a ? a.options.origin : H.origin;
        "parent" === c ? (c = N(b)) : "self" === c ? (c = a.getRect(b)) : fa(c) && (c = Ha(b, c) || { x: 0, y: 0 });
        x(c) && (c = c(a && b));
        r(c) && (c = ta(c));
    ...
    function N(a) {
        if ((a = a.parentNode) && a instanceof Xa) for (; (a = a.host) && a && a instanceof Xa; );
        return a;
    }
    function ua(a, b) {
    ...
    function ia(a, b, c) {
        for (var d = a.options, e = d[c.name].max, d = d[c.name].maxPerElement, k = 0, h = 0, f = 0, q = 0, G = w.length; q < G; q++) {
            var n = w[q],
                t = n.prepared.name;
            if (n.interacting() && (k++, k >= va || (n.target === a && ((h += (t === c.name) | 0), h >= e || (n.element === b && (f++, t !== c.name || f >= d)))))) return !1;
        }
        return 0 < va;
    }
    function wa() {
        ...
        this.matches = [];
        this.matchElements = [];
        this.inertiaStatus = { active: !1, smoothEnd: !1, ending: !1, startEvent: null, upCoords: {}, xe: 0, ye: 0, sx: 0, sy: 0, t0: 0, vx0: 0, vys: 0, duration: 0, resumeDx: 0, resumeDy: 0, lambda_v0: 0, one_ve_v0: 0, i: null };
        if (x(Function.prototype.bind)) (this.boundInertiaFrame = this.inertiaFrame.bind(this)), (this.boundSmoothEndFrame = this.smoothEndFrame.bind(this));
        else {
            var a = this;
        ...
        this.pointerDelta = { page: { x: 0, y: 0, vx: 0, vy: 0, speed: 0 }, client: { x: 0, y: 0, vx: 0, vy: 0, speed: 0 }, timeStamp: 0 };
        this.downEvent = null;
        this.downPointer = {};
        ...
        this.snapOffsets = [];
        this.gesture = { start: { x: 0, y: 0 }, startDistance: 0, prevDistance: 0, distance: 0, scale: 1, startAngle: 0, prevAngle: 0 };
        this.snapStatus = { x: 0, y: 0, dx: 0, dy: 0, realX: 0, realY: 0, snappedX: 0, snappedY: 0, targets: [], locked: !1, changed: !1 };
        ...
        if (/down|start/i.test(b))
            for (a = 0; a < d; a++) {
                ...
                if (h.inertiaStatus.active && h.target.options[h.prepared.name].inertia.allowResume && h.mouse === e)
                    for (; f; ) {
                        if (f === h.element) return h;
                        f = N(f);
                    }
            }
        if (e || (!ha && !U)) {
            for (a = 0; a < d; a++) if (w[a].mouse && !w[a].inertiaStatus.active) return w[a];
            for (a = 0; a < d; a++) if (w[a].mouse && (!/down/.test(b) || !w[a].inertiaStatus.active)) return h;
            h = new wa();
            h.mouse = !0;
            return h;
        }
        for (a = 0; a < d; a++) if (-1 !== y(w[a].pointerIds, k)) return w[a];
        if (/up|end|out/i.test(b)) return null;
        for (a = 0; a < d; a++) if (((h = w[a]), !((h.prepared.name && !h.target.options.gesture.enabled) || h.interacting() || (!e && h.mouse)))) return h;
        return new wa();
    }
    function $a(a) {
        return function (b) {
            var c,
                d = Ba(b.path ? b.path[0] : b.target),
                e = Ba(b.currentTarget),
                k;
            if (ha && /touch/.test(b.type))
                for (ab = new Date().getTime(), k = 0; k < b.changedTouches.length; k++) {
                    var h = b.changedTouches[k];
                    if ((c = Za(h, b.type, d))) c._updateEventTargets(d, e), c[a](h, b, d, e);
                }
            else {
                if (!U && /mouse/.test(b.type)) {
                    for (k = 0; k < w.length; k++) if (!w[k].mouse && w[k].pointerIsDown) return;
                    if (500 > new Date().getTime() - ab) return;
                }
                if ((c = Za(b, b.type, d))) c._updateEventTargets(d, e), c[a](b, b, d, e);
            }
        };
    }
    function I(a, b, c, d, e, k) {
        ...
        !Ja(h, c) ||
            (r && ja && ja.length) ||
            ((this.snap = { range: f.range, locked: f.locked, x: f.snappedX, y: f.snappedY, realX: f.realX, realY: f.realY, dx: f.dx, dy: f.dy }), f.locked && ((g.x += f.dx), (g.y += f.dy), (A.x += f.dx), (A.y += f.dy)));
        !Ka(h, c) || (r && p[c].restrict.elementRect) || !q.restricted || ((g.x += q.dx), (g.y += q.dy), (A.x += q.dx), (A.y += q.dy), (this.restrict = { dx: q.dx, dy: q.dy }));
        this.pageX = g.x;
        this.pageY = g.y;
        this.clientX = A.x;
        this.clientY = A.y;
        ...
        l
            ? "client" === n
                ? ((this.dx = A.x - a.startCoords.client.x), (this.dy = A.y - a.startCoords.client.y))
                : ((this.dx = g.x - a.startCoords.page.x), (this.dy = g.y - a.startCoords.page.y))
            : r
            ? (this.dy = this.dx = 0)
            : "inertiastart" === d
            ? ((this.dx = a.prevEvent.dx), (this.dy = a.prevEvent.dy))
            : "client" === n
            ? ((this.dx = A.x - a.prevEvent.clientX), (this.dy = A.y - a.prevEvent.clientY))
            : ((this.dx = g.x - a.prevEvent.pageX), (this.dy = g.y - a.prevEvent.pageY));
        a.prevEvent && "inertia" === a.prevEvent.detail && !e.active && p[c].inertia && p[c].inertia.zeroResumeDelta && ((e.resumeDx += this.dx), (e.resumeDy += this.dy), (this.dx = this.dy = 0));
        "resize" === c && a.resizeAxes
            ? p.resize.square
                ? ("y" === a.resizeAxes ? (this.dx = this.dy) : (this.dy = this.dx), (this.axes = "xy"))
                : ((this.axes = a.resizeAxes), "x" === a.resizeAxes ? (this.dy = 0) : "y" === a.resizeAxes && (this.dx = 0))
            : "gesture" === c &&
              ((this.touches = [G[0], G[1]]),
              r
                  ? ((this.distance = Fa(G, n)), (this.box = Ea(G)), (this.scale = 1), (this.ds = 0), (this.angle = Ga(G, void 0, n)), (this.da = 0))
                  : l || b instanceof I
                  ? ((this.distance = a.prevEvent.distance), (this.box = a.prevEvent.box), (this.scale = a.prevEvent.scale), (this.ds = this.scale - 1), (this.angle = a.prevEvent.angle), (this.da = this.angle - a.gesture.startAngle))
                  : ((this.distance = Fa(G, n)),
                    (this.box = Ea(G)),
        ...
        r
            ? ((this.timeStamp = a.downTimes[0]), (this.velocityY = this.velocityX = this.speed = this.duration = this.dt = 0))
            : "inertiastart" === d
            ...
            : ((this.timeStamp = new Date().getTime()),
              ...
              b instanceof I
                  ? ((b = this[t] - a.prevEvent[t]), (z = this[z] - a.prevEvent[z]), (c = this.dt / 1e3), (this.speed = ga(b, z) / c), (this.velocityX = b / c), (this.velocityY = z / c))
                  : ((this.speed = a.pointerDelta[n].speed), (this.velocityX = a.pointerDelta[n].vx), (this.velocityY = a.pointerDelta[n].vy)));
        (l || "inertiastart" === d) &&
            600 < a.prevEvent.speed &&
            150 > this.timeStamp - a.prevEvent.timeStamp &&
            ((d = (180 * Math.atan2(a.prevEvent.velocityY, a.prevEvent.velocityX)) / Math.PI),
            0 > d && (d += 360),
            (l = 112.5 <= d && 247.5 > d),
            (z = 202.5 <= d && 337.5 > d),
            (this.swipe = { up: z, down: !z && 22.5 <= d && 157.5 > d, left: l, right: !l && (292.5 <= d || 67.5 > d), angle: d, speed: a.prevEvent.speed, velocity: { x: a.prevEvent.velocityX, y: a.prevEvent.velocityY } }));
    }
    function bb() {
    ...
    function db(a, b, c) {
        ...
        if (V.resize && a.resize.enabled) {
            ...
            } else (c = "y" !== a.resize.axis && h.x > d.right - oa), (d = "x" !== a.resize.axis && h.y > d.bottom - oa), (e = c || d), (k = (c ? "x" : "") + (d ? "y" : ""));
        }
        a = e ? "resize" : V.drag && a.drag.enabled ? "drag" : null;
        V.gesture && 2 <= b.pointerIds.length && !b.dragging && !b.resizing && (a = "gesture");
        return a ? { name: a, axis: k, edges: f } : null;
    }
    function Z(a, b) {
        if (!u(a)) return null;
        var c = a.name;
    ...
    function pa(a, b) {
        ...
        for (c.preventDefault = bb; r(k); ) {
            for (a = 0; a < d.selectors.length; a++)
                if (((h = d.contexts[a]), T(k, d.selectors[a]) && ba(h, e) && ba(h, k))) {
                    h = d.listeners[a];
                    c.currentTarget = k;
                    for (var f = 0; f < h.length; f++) if (h[f][1] === b) h[f][0](c);
                }
            k = N(k);
        }
    }
    ...
    function E(a, b) {
        ...
        if (fa(a)) {
            ...
            (c = Y(a)),
                r(a, c) &&
                    (U
                        ? (n.add(this._element, L.down, l.pointerDown), n.add(this._element, L.move, l.pointerHover))
                        : (n.add(this._element, "mousedown", l.pointerDown), n.add(this._element, "mousemove", l.pointerHover), n.add(this._element, "touchstart", l.pointerDown), n.add(this._element, "touchmove", l.pointerHover)));
    ...
    function O(a, b) {
        var c = !1;
        return function () {
            c || (v.console.warn(b), (c = !0));
            return a.apply(this, arguments);
        };
    }
    function fb(a) {
        for (var b = 0; b < w.length; b++) w[b].pointerEnd(a, a);
    }
    function eb(a) {
        if (-1 === y(ka, a)) {
            var b = a.defaultView || a.parentWindow,
                c;
            for (c in R) n.add(a, c, pa), n.add(a, c, ya, !0);
            U
                ? ((L =
                      gb === b.MSPointerEvent
                          ? { up: "MSPointerUp", down: "MSPointerDown", over: "mouseover", out: "mouseout", move: "MSPointerMove", cancel: "MSPointerCancel" }
                          : { up: "pointerup", down: "pointerdown", over: "pointerover", out: "pointerout", move: "pointermove", cancel: "pointercancel" }),
                  ...
                  n.add(a, L.move, l.autoScrollMove))
                : (n.add(a, "mousedown", l.selectorDown),
            ...
            n.useAttachEvent &&
                (n.add(a, "selectstart", function (a) {
                    var b = w[0];
    ...
    if (m) {
        var v = (function () {
            ...
            S = v.document,
            Xa = v.DocumentFragment || J,
            Ua = v.SVGElement || J,
            mb = v.SVGSVGElement || J,
            kb = v.SVGElementInstance || J,
            nb = v.HTMLElement || v.Element,
            gb = v.PointerEvent || v.MSPointerEvent,
            L,
            ga =
                Math.hypot ||
                function (a, b) {
            ...
            R = {},
            H = {
                base: { accept: null, actionChecker: null, styleCursor: !0, preventDefault: "auto", origin: { x: 0, y: 0 }, deltaSource: "page", allowFrom: null, ignoreFrom: null, _context: S, dropChecker: null },
                drag: { enabled: !1, manualStart: !0, max: Infinity, maxPerElement: 1, snap: null, restrict: null, inertia: null, autoScroll: null, axis: "xy" },
            ...
            g = {
                ...
                scroll: function () {
                    ...
                    d *= k;
                    e *= a;
                    if (1 <= d || 1 <= e) M(b) ? b.scrollBy(g.x * d, g.y * e) : b && ((b.scrollLeft += g.x * d), (b.scrollTop += g.y * e)), 1 <= d && (g.prevTimeX = c), 1 <= e && (g.prevTimeY = c);
                    g.isScrolling && (aa(g.i), (g.i = W(g.scroll)));
                },
                isScrolling: !1,
                prevTimeX: 0,
                prevTimeY: 0,
            ...
            ha = "ontouchstart" in v || (v.DocumentTouch && S instanceof v.DocumentTouch),
            U = gb && !/Chrome/.test(navigator.userAgent),
            oa = ha || U ? 20 : 10,
            Na = 1,
            ab = 0,
            va = Infinity,
            ...
            V = { drag: !0, resize: !0, gesture: !0 },
            hb = "onmousewheel" in S ? "mousewheel" : "wheel",
            ea = "dragstart dragmove draginertiastart dragend dragenter dragleave dropactivate dropdeactivate dropmove drop resizestart resizemove resizeinertiastart resizeend gesturestart gesturemove gestureinertiastart gestureend down move up cancel tap doubletap hold".split(
                " "
            ),
            X = {},
            Sa = "Opera" == navigator.appName && ha && navigator.userAgent.match("Presto"),
            lb = /iP(hone|od|ad)/.test(navigator.platform) && /OS 7[^\d]/.test(navigator.appVersion),
            La =
                "matches" in Element.prototype
                    ...
                    : "msMatchesSelector",
            la,
            W = m.requestAnimationFrame,
            aa = m.cancelAnimationFrame,
            n = (function () {
                function a(b, c, d, k) {
                    var t,
                        l = y(q, b),
                    ...
                    if (g && g.events) {
                        ...
                        if ("all" === c) for (c in g.events) g.events.hasOwnProperty(c) && a(b, c, "all");
                        else {
                            if (g.events[c]) {
                                var r = g.events[c].length;
                                if ("all" === d) {
                                    for (t = 0; t < r; t++) a(b, c, g.events[c][t], !!k);
                                    return;
                                }
                                for (t = 0; t < r; t++)
                                    if (g.events[c][t] === d) {
                                        ...
                                        e && z && (z.useCount[m]--, 0 === z.useCount[m] && (z.supplied.splice(m, 1), z.wrapped.splice(m, 1), z.useCount.splice(m, 1)));
                                        break;
                                    }
                                g.events[c] && 0 === g.events[c].length && ((g.events[c] = null), g.typeCount--);
                            }
                            g.typeCount || (G.splice(l, 1), q.splice(l, 1), n.splice(l, 1));
                        }
                    }
                }
                function b() {
                ...
                return {
                    add: function (a, h, g, l) {
                        var t = y(q, a),
                            m = G[t];
                        m || ((m = { events: {}, typeCount: 0 }), (t = q.push(a) - 1), G.push(m), n.push(e ? { supplied: [], wrapped: [], useCount: [] } : null));
                        m.events[h] || ((m.events[h] = []), m.typeCount++);
                        if (-1 === y(m.events[h], g)) {
                            if (e) {
                                var t = n[t],
                                    p = y(t.supplied, g),
                                    z =
                                        ...
                                        function (e) {
                                            e.immediatePropagationStopped ||
                                                ...
                                                /mouse|click/.test(e.type) && ((e.pageX = e.clientX + Y(a).document.documentElement.scrollLeft), (e.pageY = e.clientY + Y(a).document.documentElement.scrollTop)),
                                                g(e));
                                        };
                                l = a[k](f + h, z, !!l);
                                -1 === p ? (t.supplied.push(g), t.wrapped.push(z), t.useCount.push(1)) : t.useCount[p]++;
                            } else l = a[k](h, g, l || !1);
                            m.events[h].push(g);
                            return l;
                        }
            ...
            za = { webkit: /(Movement[XY]|Radius[XY]|RotationAngle|Force)$/ };
        wa.prototype = {
            ...
            pointerOver: function (a, b, c) {
                function d(a, b) {
                    a && r(c) && ua(a, c) && !ca(a, c, c) && da(a, c, c) && T(c, b) && (e.push(a), k.push(c));
                }
                if (!this.prepared.name && this.mouse) {
                    var e = [],
                        ...
                        h = this.element;
                    this.addPointer(a);
                    !this.target || (!ca(this.target, this.element, c) && da(this.target, this.element, c)) || ((this.element = this.target = null), (this.matches = []), (this.matchElements = []));
                    var f = D.get(c),
                        q = f && !ca(f, c, c) && da(f, c, c) && Z(f.getAction(a, b, this, c), f);
                    q && !ia(f, c, q) && (q = null);
                    q
                        ? ((this.target = f), (this.element = c), (this.matches = []), (this.matchElements = []))
                        : (D.forEachSelector(d),
                          this.validateSelector(a, b, e, k)
                              ? ((this.matches = e), (this.matchElements = k), this.pointerHover(a, b, this.matches, this.matchElements), n.add(c, U ? L.move : "mousemove", l.pointerHover))
                              : this.target &&
                                (ba(h, c)
                                    ? (this.pointerHover(a, b, this.matches, this.matchElements), n.add(this.element, U ? L.move : "mousemove", l.pointerHover))
                                    : ((this.element = this.target = null), (this.matches = []), (this.matchElements = []))));
                }
            },
            ...
            pointerOut: function (a, b, c) {
                this.prepared.name || (D.get(c) || n.remove(c, U ? L.move : "mousemove", l.pointerHover), this.target && this.target.options.styleCursor && !this.interacting() && (this.target._doc.documentElement.style.cursor = ""));
            },
            selectorDown: function (a, b, c, d) {
                function e(a, b, d) {
                    d = la ? d.querySelectorAll(b) : void 0;
                    ua(a, f) && !ca(a, f, c) && da(a, f, c) && T(f, b, d) && (k.matches.push(a), k.matchElements.push(f));
                }
                var k = this,
                ...
                if (!this.interacting()) {
                    ...
                    if (g) return (this.prepared.name = g.name), (this.prepared.axis = g.axis), (this.prepared.edges = g.edges), this.collectEventTargets(a, b, c, "down"), this.pointerDown(a, b, c, d, g);
            ...
            pointerDown: function (a, b, c, d, e) {
                if (!e && !this.inertiaStatus.active && this.pointerWasMoved && this.prepared.name) this.checkAndPreventDefault(b, this.target, this.element);
                else {
                    this.pointerIsDown = !0;
                    this.downEvent = b;
                    var k = this.addPointer(a),
                        h;
                    ...
                    } else this.prepared.name || ((f = D.get(d)) && !ca(f, d, c) && da(f, d, c) && (h = Z(e || f.getAction(a, b, this, d), f, c)) && ia(f, d, h) && ((this.target = f), (this.element = d)));
                    var q = (f = this.target) && f.options;
                    !f || (!e && this.prepared.name)
                        ? this.inertiaStatus.active &&
                          d === this.element &&
                          Z(f.getAction(a, b, this, this.element), f).name === this.prepared.name &&
                          (aa(this.inertiaStatus.i), (this.inertiaStatus.active = !1), this.checkAndPreventDefault(b, f, this.element))
                        : ((h = h || Z(e || f.getAction(a, b, this, d), f, this.element)),
                          this.setEventXY(this.startCoords, this.pointers),
                          h &&
                              (q.styleCursor && (f._doc.documentElement.style.cursor = cb(h)),
            ...
            setStartOffsets: function (a, b, c) {
                ...
                d = c && "startCoords" === c.offset ? { x: this.startCoords.page.x - d.x, y: this.startCoords.page.y - d.y } : (c && c.offset) || { x: 0, y: 0 };
                if (a && c && c.relativePoints && c.relativePoints.length)
                    for (var h = 0; h < c.relativePoints.length; h++) this.snapOffsets.push({ x: this.startOffset.left - e * c.relativePoints[h].x + d.x, y: this.startOffset.top - k * c.relativePoints[h].y + d.y });
                else this.snapOffsets.push(d);
                a && b.elementRect
                    ? ((this.restrictOffset.left = this.startOffset.left - e * b.elementRect.left),
                      ...
                      (this.restrictOffset.bottom = this.startOffset.bottom - k * (1 - b.elementRect.bottom)))
            ...
            pointerMove: function (a, b, c, d, e) {
                if (this.inertiaStatus.active) {
                    ...
                    this.setEventXY(this.curCoords, [{ pageX: d.x + this.inertiaStatus.sx, pageY: d.y + this.inertiaStatus.sy, clientX: k.x + this.inertiaStatus.sx, clientY: k.y + this.inertiaStatus.sy }]);
                ...
                d || (this.pointerIsDown && !this.pointerWasMoved) || (this.pointerIsDown && clearTimeout(this.holdTimers[k]), this.collectEventTargets(a, b, c, "move"));
                if (this.pointerIsDown)
                    if (d && this.pointerWasMoved && !e) this.checkAndPreventDefault(b, this.target, this.element);
                    else if ((Qa(this.pointerDelta, this.prevCoords, this.curCoords), this.prepared.name)) {
                        if (this.pointerWasMoved && (!this.inertiaStatus.active || (a instanceof I && /inertiastart/.test(a.type)))) {
                            if (!this.interacting() && (Qa(this.pointerDelta, this.prevCoords, this.curCoords), "drag" === this.prepared.name)) {
                                h = Math.abs(h);
                                f = Math.abs(f);
                                    ...
                                    if (!this.prepared.name) {
                                        ...
                                        f = function (a, b, d) {
                                            ...
                                            if (
                                                a !== n.target &&
                                                ua(a, c) &&
                                                !a.options.drag.manualStart &&
                                                !ca(a, g, c) &&
                                                da(a, g, c) &&
                                                T(g, b, d) &&
                                                "drag" === a.getAction(n.downPointer, n.downEvent, n, g).name &&
                                                Ya(q, a) &&
                                                ia(a, g, "drag")
                                            )
                                                return a;
                            ...
                            if (this.prepared.name && this.target) {
                                ...
                                if (this.setModifications(this.curCoords.page, e) || f) this.prevEvent = this[this.prepared.name + "Move"](b);
            ...
            resizeStart: function (a) {
                ...
                if (this.prepared.edges) {
                    ...
                    this.resizeRects = { start: b, current: C({}, b), restricted: C({}, b), previous: C({}, b), delta: { left: 0, right: 0, width: 0, top: 0, bottom: 0, height: 0 } };
            ...
            resizeMove: function (a) {
                ...
                if (b) {
                    ...
                    if (this.target.options.resize.preserveAspectRatio) {
                        ...
                        if ((l.left && l.bottom) || (l.right && l.top)) k = -e / m;
                        else if (l.left || l.right) k = e / m;
                        else if (l.top || l.bottom) e = k * m;
                    } else if (this.target.options.resize.square)
                        if (((b = this.prepared._linkedEdges), (l.left && l.bottom) || (l.right && l.top))) k = -e;
                        else if (l.left || l.right) k = e;
                        else if (l.top || l.bottom) e = k;
                    b.top && (f.top += k);
                    b.bottom && (f.bottom += k);
                    b.left && (f.left += e);
                    b.right && (f.right += e);
                    d
                        ? (C(q, f), "reposition" === c && (q.top > q.bottom && ((b = q.top), (q.top = q.bottom), (q.bottom = b)), q.left > q.right && ((b = q.left), (q.left = q.right), (q.right = b))))
                        : ((q.top = Math.min(f.top, h.bottom)), (q.bottom = Math.max(f.bottom, h.top)), (q.left = Math.min(f.left, h.right)), (q.right = Math.max(f.right, h.left)));
                    q.width = q.right - q.left;
                    q.height = q.bottom - q.top;
                    for (var p in q) g[p] = q[p] - n[p];
            ...
            ie8Dblclick: function (a, b, c) {
                this.prevTap &&
                    ...
                    ((this.downTargets[0] = c), (this.downTimes[0] = new Date().getTime()), this.collectEventTargets(a, b, c, "tap"));
            },
            pointerEnd: function (a, b, c, d) {
                ...
                if (this.interacting()) {
                    if (f.active && !f.ending) return;
                    var q = new Date().getTime(),
                        g,
                        l = !1,
                        n = Ja(e, this.prepared.name) && k[this.prepared.name].snap.endOnly,
                        m = Ka(e, this.prepared.name) && k[this.prepared.name].restrict.endOnly,
                        p = 0,
                        r = 0,
                        k = this.dragging ? ("x" === k.drag.axis ? Math.abs(this.pointerDelta.client.vx) : "y" === k.drag.axis ? Math.abs(this.pointerDelta.client.vy) : this.pointerDelta.client.speed) : this.pointerDelta.client.speed,
                        h = (g = h && h.enabled && "gesture" !== this.prepared.name && b !== f.startEvent) && 50 > q - this.curCoords.timeStamp && k > h.minSpeed && k > h.endSpeed;
                    g &&
                        !h &&
                        (n || m) &&
                        ((g = {}),
                        (g.snap = g.restrict = g),
                        n && (this.setSnapping(this.curCoords.page, g), g.locked && ((p += g.dx), (r += g.dy))),
                        m && (this.setRestriction(this.curCoords.page, g), g.restricted && ((p += g.dx), (r += g.dy))),
                        p || r) &&
                        (l = !0);
                    if (h || l) {
                        ...
                        e.fire(f.startEvent);
                        h
                            ? ((f.vx0 = this.pointerDelta.client.vx),
                              ...
                              (b.x = b.x + f.xe - e.x),
                              (b.y = b.y + f.ye - e.y),
                              (e = { useStatusXY: !0, x: b.x, y: b.y, dx: 0, dy: 0, snap: null }),
                              (e.snap = e),
                              (p = r = 0),
                              n && ((b = this.setSnapping(this.curCoords.page, e)), b.locked && ((p += b.dx), (r += b.dy))),
                              m && ((e = this.setRestriction(this.curCoords.page, e)), e.restricted && ((p += e.dx), (r += e.dy))),
                              (f.modifiedXe += p),
                              (f.modifiedYe += r),
                              (f.i = W(this.boundInertiaFrame)))
                            : ((f.smoothEnd = !0), (f.xe = p), (f.ye = r), (f.sx = f.sy = 0), (f.i = W(this.boundSmoothEndFrame)));
                        f.active = !0;
                        return;
                    }
                ...
                this.dragging
                    ? ((f = new I(this, b, "drag", "end", this.element)),
                      ...
                      e.fire(f))
                    : this.resizing
                    ? ((f = new I(this, b, "resize", "end", this.element)), e.fire(f))
                    : this.gesturing && ((f = new I(this, b, "gesture", "end", this.element)), e.fire(f));
                this.stop(b);
            },
                ...
                for (var h, e = [], f, k = 1; k < d.length; k++)
                    if ((a = d[k]) && a !== b)
                        if (!b) (b = a), (c = k);
                            ...
                            if (b.parentNode === a.ownerDocument) (b = a), (c = k);
                            else {
                                if (!e.length) for (h = b; h.parentNode && h.parentNode !== h.ownerDocument; ) e.unshift(h), (h = h.parentNode);
                                if (b instanceof nb && a instanceof Ua && !(a instanceof mb)) {
                                    if (a === b.parentNode) continue;
                                    h = a.ownerSVGElement;
                                } else h = a;
                                for (f = []; h.parentNode !== h.ownerDocument; ) f.unshift(h), (h = h.parentNode);
                                for (h = 0; f[h] && f[h] === e[h]; ) h++;
                                h = [f[h - 1], f[h], e[h]];
            ...
            getDropEvents: function (a, b) {
                a = { enter: null, leave: null, activate: null, deactivate: null, move: null, drop: null };
                this.dropElement !== this.prevDropElement &&
                    (this.prevDropTarget &&
                        ((a.leave = { target: this.prevDropElement, dropzone: this.prevDropTarget, relatedTarget: b.target, draggable: b.interactable, dragEvent: b, interaction: this, timeStamp: b.timeStamp, type: "dragleave" }),
                        (b.dragLeave = this.prevDropElement),
                        (b.prevDropzone = this.prevDropTarget)),
                    this.dropTarget &&
                        ((a.enter = { target: this.dropElement, dropzone: this.dropTarget, relatedTarget: b.target, draggable: b.interactable, dragEvent: b, interaction: this, timeStamp: b.timeStamp, type: "dragenter" }),
                        (b.dragEnter = this.dropElement),
                        (b.dropzone = this.dropTarget)));
                "dragend" === b.type &&
                    this.dropTarget &&
                    ((a.drop = { target: this.dropElement, dropzone: this.dropTarget, relatedTarget: b.target, draggable: b.interactable, dragEvent: b, interaction: this, timeStamp: b.timeStamp, type: "drop" }),
                    (b.dropzone = this.dropTarget));
                "dragstart" === b.type && (a.activate = { target: null, dropzone: null, relatedTarget: b.target, draggable: b.interactable, dragEvent: b, interaction: this, timeStamp: b.timeStamp, type: "dropactivate" });
                "dragend" === b.type && (a.deactivate = { target: null, dropzone: null, relatedTarget: b.target, draggable: b.interactable, dragEvent: b, interaction: this, timeStamp: b.timeStamp, type: "dropdeactivate" });
                "dragmove" === b.type &&
                    this.dropTarget &&
                    ((a.move = { target: this.dropElement, dropzone: this.dropTarget, relatedTarget: b.target, draggable: b.interactable, dragEvent: b, interaction: this, dragmove: b, timeStamp: b.timeStamp, type: "dropmove" }),
                    (b.dropzone = this.dropTarget));
                return a;
            },
            ...
            stop: function (a) {
                ...
                for (a = this.inertiaStatus.resumeDx = this.inertiaStatus.resumeDy = 0; a < this.pointers.length; a++) -1 === y(this.pointerIds, Q(this.pointers[a])) && this.pointers.splice(a, 1);
            },
            inertiaFrame: function () {
                ...
                if (c < a.te) {
                    ...
                    if (a.modifiedXe === a.xe && a.modifiedYe === a.ye) (a.sx = a.xe * c), (a.sy = a.ye * c);
                    else {
                        var d = a.ye,
                            e = a.modifiedYe;
            ...
            removePointer: function (a) {
                ...
                -1 !== a && (this.pointers.splice(a, 1), this.pointerIds.splice(a, 1), this.downTargets.splice(a, 1), this.downTimes.splice(a, 1), this.holdTimers.splice(a, 1));
            },
            ...
            collectEventTargets: function (a, b, c, d) {
                function e(a, b, e) {
                    ...
                    a._iEvents[d] && r(g) && ua(a, g) && !ca(a, g, c) && da(a, g, c) && T(g, b, e) && (h.push(a), f.push(g));
                }
                var k = this.mouse ? 0 : y(this.pointerIds, Q(a));
                if ("tap" !== d || (!this.pointerWasMoved && this.downTargets[k] && this.downTargets[k] === c)) {
                    for (var h = [], f = [], g = c; g; ) p.isSet(g) && p(g)._iEvents[d] && (h.push(p(g)), f.push(g)), D.forEachSelector(e), (g = N(g));
            ...
            firePointers: function (a, b, c, d, e, k) {
                ...
                for (a = 0; a < d.length && !((f.currentTarget = e[a]), (f.interactable = d[a]), d[a].fire(f), f.immediatePropagationStopped || (f.propagationStopped && e[a + 1] !== f.currentTarget)); a++);
                l ? ((d = {}), C(d, f), (d.dt = g), (d.type = "doubletap"), this.collectEventTargets(d, b, c, "doubletap"), (this.prevTap = d)) : "tap" === k && (this.prevTap = f);
            },
            validateSelector: function (a, b, c, d) {
                for (var e = 0, k = c.length; e < k; e++) {
                    ...
                    if (g && ia(h, f, g)) return (this.target = h), (this.element = f), g;
                }
            },
            setSnapping: function (a, b) {
                var c = this.target.options[this.prepared.name].snap,
                    ...
                    e;
                b = b || this.snapStatus;
                if (b.useStatusXY) a = { x: b.x, y: b.y };
                else {
                ...
                for (var h = c.targets ? c.targets.length : 0, f = 0; f < this.snapOffsets.length; f++) {
                    ...
                    for (e = 0; e < h; e++)
                        (k = x(c.targets[e]) ? c.targets[e](g, l, this) : c.targets[e]) && d.push({ x: F(k.x) ? k.x + this.snapOffsets[f].x : g, y: F(k.y) ? k.y + this.snapOffsets[f].y : l, range: F(k.range) ? k.range : c.range });
                }
                var c = null,
                    f = !1,
                    m = 0,
                ...
                for (h = d.length; e < h; e++) {
                    ...
                    if (!c || (w ? (f && Infinity !== p ? v / p < m / n : (Infinity === p && Infinity !== n) || v < m) : !f && v < m)) Infinity === p && (w = !0), (c = k), (m = v), (n = p), (f = w), (g = r), (l = u), (b.range = p);
                }
            ...
            setRestriction: function (a, b) {
                ...
                d = b.useStatusXY ? (d = { x: b.x, y: b.y }) : (d = C({}, a));
                ...
                b.dy = 0;
                b.restricted = !1;
                if (P(e) && ((e = "parent" === e ? N(this.element) : "self" === e ? c.getRect(this.element) : Ha(this.element, e)), !e)) return b;
                x(e) && (e = e(d.x, d.y, this.element));
                r(e) && (e = ta(e));
                (a = e)
                    ? "x" in e && "y" in e
                        ? ((c = Math.max(Math.min(a.x + a.width - this.restrictOffset.right, d.x), a.x + this.restrictOffset.left)), (a = Math.max(Math.min(a.y + a.height - this.restrictOffset.bottom, d.y), a.y + this.restrictOffset.top)))
                        : ((c = Math.max(Math.min(a.right - this.restrictOffset.right, d.x), a.left + this.restrictOffset.left)), (a = Math.max(Math.min(a.bottom - this.restrictOffset.bottom, d.y), a.top + this.restrictOffset.top)))
                    : ((c = d.x), (a = d.y));
                b.dx = c - d.x;
                b.dy = a - d.y;
            ...
            checkAndPreventDefault: function (a, b, c) {
                if ((b = b || this.target)) {
                    ...
                    "auto" === d && c && !/^(input|select|textarea)$/i.test(a.target.nodeName)
                        ? (/down|start/i.test(a.type) && "drag" === this.prepared.name && "xy" !== b.drag.axis) || (b[this.prepared.name] && b[this.prepared.name].manualStart && !this.interacting()) || a.preventDefault()
            ...
            autoScrollMove: function (a) {
                ...
                if (b)
                    if (this.inertiaStatus.active) g.x = g.y = 0;
                    else {
                        ...
                        } else (e = Ca(e)), (k = a.clientX < e.left + g.margin), (b = a.clientY < e.top + g.margin), (c = a.clientX > e.right - g.margin), (a = a.clientY > e.bottom - g.margin);
                        g.x = c ? 1 : k ? -1 : 0;
                        g.y = a ? 1 : b ? -1 : 0;
                        g.isScrolling || ((g.margin = d.margin), (g.speed = d.speed), g.start(this));
                    }
            },
        ...
        for (
            var l = {},
                ib = "dragStart dragMove resizeStart resizeMove gestureStart gestureMove pointerOver pointerOut pointerHover selectorDown pointerDown pointerMove pointerUp pointerCancel pointerEnd addPointer removePointer recordPointer autoScrollMove".split(
                    " "
                ),
                Oa = 0,
                Pa = ib.length;
        ...
        E.prototype = {
            setOnEvents: function (a, b) {
                "drop" === a
                    ? (x(b.ondrop) && (this.ondrop = b.ondrop),
                      ...
                      x(b.ondropmove) && (this.ondropmove = b.ondropmove))
                    : ((a = "on" + a),
            ...
            draggable: function (a) {
                return u(a)
                    ? ((this.options.drag.enabled = !1 === a.enabled ? !1 : !0),
            ...
            setPerAction: function (a, b) {
                for (var c in b)
                    c in H[a] &&
                        (u(b[c])
                            ? ((this.options[a][c] = C(this.options[a][c] || {}, b[c])), u(H.perAction[c]) && "enabled" in H.perAction[c] && (this.options[a][c].enabled = !1 === b[c].enabled ? !1 : !0))
                            : K(b[c]) && u(H.perAction[c])
                            ? (this.options[a][c].enabled = b[c])
                            : void 0 !== b[c] && (this.options[a][c] = b[c]));
            },
            dropzone: function (a) {
                return u(a)
                    ? ((this.options.drop.enabled = !1 === a.enabled ? !1 : !0),
            ...
            dropCheck: function (a, b, c, d, e, k) {
                var h = !1;
                if (!(k = k || this.getRect(e))) return this.options.drop.checker ? this.options.drop.checker(a, b, h, this, e, c, d) : !1;
            ...
            dropChecker: function (a) {
                return x(a) ? ((this.options.drop.checker = a), this) : null === a ? (delete this.options.getRect, this) : this.options.drop.checker;
            },
            accept: function (a) {
                return r(a) || fa(a) ? ((this.options.drop.accept = a), this) : null === a ? (delete this.options.drop.accept, this) : this.options.drop.accept;
            },
            resizable: function (a) {
                return u(a)
                    ? ((this.options.resize.enabled = !1 === a.enabled ? !1 : !0),
            ...
            squareResize: function (a) {
                return K(a) ? ((this.options.resize.square = a), this) : null === a ? (delete this.options.resize.square, this) : this.options.resize.square;
            },
            gesturable: function (a) {
                return u(a) ? ((this.options.gesture.enabled = !1 === a.enabled ? !1 : !0), this.setPerAction("gesture", a), this.setOnEvents("gesture", a), this) : K(a) ? ((this.options.gesture.enabled = a), this) : this.options.gesture;
            },
            autoScroll: function (a) {
                u(a) ? (a = C({ actions: ["drag", "resize"] }, a)) : K(a) && (a = { actions: ["drag", "resize"], enabled: a });
            ...
            setOptions: function (a, b) {
                var c = b && B(b.actions) ? b.actions : ["drag"],
                    d;
                if (u(b) || K(b)) {
                        ...
                        u(this.options[e]) &&
                            ...
                            u(b)
                                ? (C(e, b),
                                  ...
                                  "snap" === a &&
                                      ("grid" === e.mode
                                          ? (e.targets = [p.createSnapGrid(C({ offset: e.gridOffset || { x: 0, y: 0 } }, e.grid || {}))])
                                          : "anchor" === e.mode
                                          ? (e.targets = e.anchors)
                                          : "path" === e.mode && (e.targets = e.paths),
                                      "elementOrigin" in b && (e.relativePoints = [b.elementOrigin])))
                                : K(b) && (e.enabled = b));
                    }
                    return this;
                }
                ...
                for (d = 0; d < c.length; d++) a in H[c[d]] && (b[c[d]] = this.options[c[d]][a]);
                return b;
            },
            inertia: function (a) {
            ...
            actionChecker: function (a) {
                return x(a) ? ((this.options.actionChecker = a), this) : null === a ? (delete this.options.actionChecker, this) : this.options.actionChecker;
            },
            getRect: function (a) {
                a = a || this._element;
            ...
            rectChecker: function (a) {
                return x(a) ? ((this.getRect = a), this) : null === a ? (delete this.options.getRect, this) : this.getRect;
            },
            styleCursor: function (a) {
                return K(a) ? ((this.options.styleCursor = a), this) : null === a ? (delete this.options.styleCursor, this) : this.options.styleCursor;
            },
            preventDefault: function (a) {
                return /^(always|never|auto)$/.test(a) ? ((this.options.preventDefault = a), this) : K(a) ? ((this.options.preventDefault = a ? "always" : "never"), this) : this.options.preventDefault;
            },
            origin: function (a) {
                return fa(a) || u(a) ? ((this.options.origin = a), this) : this.options.origin;
            },
            deltaSource: function (a) {
                return "page" === a || "client" === a ? ((this.options.deltaSource = a), this) : this.options.deltaSource;
            },
            restrict: function (a) {
                if (!u(a)) return this.setOptions("restrict", a);
                for (var b = ["drag", "resize", "gesture"], c, d = 0; d < b.length; d++) {
                    var e = b[d];
                    e in a && ((c = C({ actions: [e], restriction: a[e] }, a)), (c = this.setOptions("restrict", c)));
                }
                return c;
            },
            context: function () {
            ...
            ignoreFrom: function (a) {
                return fa(a) || r(a) ? ((this.options.ignoreFrom = a), this) : this.options.ignoreFrom;
            },
            allowFrom: function (a) {
                return fa(a) || r(a) ? ((this.options.allowFrom = a), this) : this.options.allowFrom;
            },
            element: function () {
                return this._element;
            },
            fire: function (a) {
                if (!a || !a.type || -1 === y(ea, a.type)) return this;
                var b,
                    c = "on" + a.type;
                if (a.type in this._iEvents) {
                    var d = this._iEvents[a.type];
                    var e = 0;
                    for (b = d.length; e < b && !a.immediatePropagationStopped; e++) d[e](a);
                }
                if (x(this[c])) this[c](a);
                if (a.type in X && (d = X[a.type])) for (e = 0, b = d.length; e < b && !a.immediatePropagationStopped; e++) d[e](a);
                return this;
            },
            on: function (a, b, c) {
                var d;
                ...
                if (u(a)) {
                    for (d in a) this.on(d, a[d], b);
                    return this;
                }
                "wheel" === a && (a = hb);
                c = c ? !0 : !1;
                if (-1 !== y(ea, a)) a in this._iEvents ? this._iEvents[a].push(b) : (this._iEvents[a] = [b]);
                else if (this.selector) {
                    if (!R[a]) for (R[a] = { selectors: [], contexts: [], listeners: [] }, d = 0; d < ka.length; d++) n.add(ka[d], a, pa), n.add(ka[d], a, ya, !0);
                    a = R[a];
            ...
            off: function (a, b, c) {
                ...
                c = c ? !0 : !1;
                "wheel" === a && (a = hb);
                if (-1 !== y(ea, a)) (c = this._iEvents[a]) && -1 !== (e = y(c, b)) && this._iEvents[a].splice(e, 1);
                else if (this.selector) {
                    var g = R[a],
                        h = !1;
                    if (!g) return this;
                    for (e = g.selectors.length - 1; 0 <= e; e--)
                        if (g.selectors[e] === this.selector && g.contexts[e] === this._context) {
                            ...
                            for (d = f.length - 1; 0 <= d; d--) {
                                ...
                                if (f[d][0] === b && l === c) {
                                    f.splice(d, 1);
                                    f.length || (g.selectors.splice(e, 1), g.contexts.splice(e, 1), g.listeners.splice(e, 1), n.remove(this._context, a, pa), n.remove(this._context, a, ya, !0), g.selectors.length || (R[a] = null));
                                    h = !0;
                                    break;
                                }
                            }
            ...
            set: function (a) {
                ...
                b = 0;
                for (Pa = g.length; b < Pa; b++) if (((c = g[b]), (this.options[c] = H.base[c]), c in a)) this[c](a[c]);
                return this;
            },
            unset: function () {
                ...
                if (P(this.selector))
                    for (var a in R)
                        for (var b = R[a]; 0 < b.selectors.length; ) {
                            b.selectors[0] === this.selector && b.contexts[0] === this._context && (b.selectors.splice(0, 1), b.contexts.splice(0, 1), b.listeners.splice(0, 1), b.selectors.length || (R[a] = null));
        ...
        p.on = function (a, b, c) {
            P(a) && -1 !== a.search(" ") && (a = a.trim().split(/ +/));
            if (B(a)) {
                for (var d = 0; d < a.length; d++) p.on(a[d], b, c);
                return p;
            }
            if (u(a)) {
                for (d in a) p.on(d, a[d], b);
                return p;
            }
        ...
        p.off = function (a, b, c) {
            P(a) && -1 !== a.search(" ") && (a = a.trim().split(/ +/));
            if (B(a)) {
                for (var d = 0; d < a.length; d++) p.off(a[d], b, c);
                return p;
            }
            if (u(a)) {
                for (d in a) p.off(d, a[d], b);
                return p;
            }
            if (-1 === y(ea, a)) n.remove(S, a, b, c);
            else {
                var e;
        ...
        p.enableDragging = O(function (a) {
            return null !== a && void 0 !== a ? ((V.drag = a), p) : V.drag;
        }, "interact.enableDragging is deprecated and will soon be removed.");
        p.enableResizing = O(function (a) {
            return null !== a && void 0 !== a ? ((V.resize = a), p) : V.resize;
        }, "interact.enableResizing is deprecated and will soon be removed.");
        p.enableGesturing = O(function (a) {
            return null !== a && void 0 !== a ? ((V.gesture = a), p) : V.gesture;
        ...
        (function () {
            for (var a = 0, b = ["ms", "moz", "webkit", "o"], c = 0; c < b.length && !m.requestAnimationFrame; ++c) (W = m[b[c] + "RequestAnimationFrame"]), (aa = m[b[c] + "CancelAnimationFrame"] || m[b[c] + "CancelRequestAnimationFrame"]);
            W ||
                (W = function (b) {
        ...
        "undefined" !== typeof exports
            ? ("undefined" !== typeof module && module.exports && (exports = module.exports = p), (exports.interact = p))
